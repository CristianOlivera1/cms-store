                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-10 col-lg-7">
                        ...
                        <div class="section-heading text-center">
                            ...
                            <p class="text-white d-none d-sm-block mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita eos laudantium vel sequi vero? Adipisci ab reiciendis, sint esse quas iure provident nemo, rem id, blanditiis porro molestias. Dolorem, dolores.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-lg-5">
                        ...
                        <div class="section-heading text-center mb-3">
                            <h2>Contactanos</h2>
                            <p class="d-none d-sm-block mt-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corrupti, ipsa dolor, velit sed a voluptates soluta, esse doloremque explicabo expedita facere libero? Accusantium sint ea quos expedita? Delectus, tenetur repellendus?</p>
                        </div>
                        <!-- Contact Us -->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10">
                        ...
                        <div class="section-heading text-center m-0">
                            <h2 class="text-white">Otro mas</h2>
                            <p class="text-white d-none d-sm-block mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam doloribus adipisci tenetur voluptatibus, amet atque ad ipsa praesentium natus, officiis delectus. Delectus iusto sequi dolor officiis atque laudantium quia ipsam.</p>
