...
?>
    ...
    $ufile = "$tr[ufile]";
    $service_desc_small="$tr[service_desc]";
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="about-content section-heading text-center text-lg-left pl-md-4 mt-5 mt-lg-0 mb-0">
                            ...
                            <p style="color:rgb(82, 82, 91); margin-top:-10px; margin-bottom:20px;"><?php print $service_desc_small;?></p>
                            <p style="color:black; font-size: 17px"><?php print $service_detail;?></p>
                            <!-- Counter Area -->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10">
                        ...
                        <div class="section-heading text-center m-0">
                            ...
                            <p class="text-white d-none d-sm-block mt-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Tempora animi maxime totam, in facilis, dolore dolores repellendus amet itaque culpa magni a eos explicabo laboriosam voluptatem nemo commodi impedit necessitatibus!</p>
