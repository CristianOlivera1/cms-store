                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-lg-5">
                        ...
                        <div class="section-heading text-center mb-3">
                            <h2>Contactanos</h2>
                            <p class="d-none d-sm-block mt-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequuntur, voluptate? Dolores numquam qui similique aperiam! Magni adipisci ex, consectetur aspernatur dolores laboriosam! Adipisci nihil autem consectetur. Impedit dolores voluptates excepturi.</p>
                        </div>
                        <!-- Contact Us -->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10">
                        ...
                        <div class="section-heading text-center m-0">
                            ...
                            <p class="text-white d-none d-sm-block mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui porro, modi quo ipsum iusto dolorem iste molestiae corrupti sed natus hic odit fuga et, cumque, ratione doloremque dicta quod! Non.</p>
